...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create OYL-51b7
  fly apps create OYL-51b7-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app OYL-51b7
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app OYL-51b7-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'OYL-51b7-staging' does not match app name in config file 'OYL-51b7'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name OYL-51b7-db
  fly postgres attach --app OYL-51b7 OYL-51b7-db

  fly postgres create --name OYL-51b7-staging-db
  fly postgres attach --app OYL-51b7-staging OYL-51b7-staging-db
  ```
