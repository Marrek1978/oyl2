/*
  ...
  - You are about to drop the `SavingTracker` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "SavingTracker" DROP CONSTRAINT "SavingTracker_projectId_fkey";

-- DropForeignKey
ALTER TABLE "SavingTracker" DROP CONSTRAINT "SavingTracker_userId_fkey";

-- DropTable
DROP TABLE "HabitTracker";

-- DropTable
DROP TABLE "SavingTracker";
