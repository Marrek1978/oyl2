          ...
          <div className="container mx-auto xl:px-32">
            <div className="grid items-center lg:grid-cols-2">
              <div className="mb-12 lg:mb-0">
                <div
                  className="block rounded-lg bg-base-100 px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:shadow-black/20 md:px-12 lg:-mr-14 backdrop-blur-[30px]">
                  <h2 className="mb-6 pb-2 text-4xl font-bold">Call To Action</h2>
              ...
              <div>
                <img src="https://tecdn.b-cdn.net/img/new/ecommerce/vertical/132.jpg"
