          ...
          <div className="px-6 py-12 md:px-12">
            <div className="flex  items-center gap-12 lg:grid-cols-2">
              ...
              <div className="mb-12 lg:mb-0">
                <div
                  className="block rounded-lg bg-white px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-800 md:px-12">
                  <form>
                    ...
                    <div className="mb-6 flex min-h-[1.5rem] justify-center pl-[1.5rem]">
                      <input
                        ...
                        type="checkbox" value="" id="flexCheckChecked" onChange={()=>{}} />
                      <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="flexCheckChecked">
